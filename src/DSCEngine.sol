...
contract DSCEngine is ReentrancyGuard {
    ...
    function getAccountInformation(address user) external view returns(uint totalDscMinted, uint collateralValue) {
        (totalDscMinted, collateralValue) = _getAccountInfo(user);
    }
